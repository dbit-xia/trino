...
public class SqlServerConfig
{
    ...
    @Config("sybase.bulk-copy-for-write.enabled")
    ...
    @Config("sybase.bulk-copy-for-write.lock-destination-table")
    ...
    @Config("sybase.snapshot-isolation.disabled")
    ...
    @Config("sybase.experimental.stored-procedure-table-function-enabled")
