        ...
        extends BaseJdbcClient
{
    ...
    protected Map<String, CaseSensitivity> getCaseSensitivityForColumns(ConnectorSession session, Connection connection, JdbcTableHandle tableHandle)
    {
        ...
        try (PreparedStatement preparedStatement = queryBuilder.prepareStatement(this, session, connection, preparedQuery, Optional.empty())) {
            ...
            if (e instanceof SybSQLException sqlServerException && sqlServerException.getErrorCode() == 208) {
    ...
    public static ColumnMapping datetimeColumnMapping(int precision)
    {
        return timestampColumnMappingUsingSqlTimestampWithRounding(createTimestampType(precision));
    }
    ...
    public Optional<ColumnMapping> toColumnMapping(ConnectorSession session, Connection connection, JdbcTypeHandle typeHandle)
    {
        ...
        switch (jdbcTypeName) {
            ...
            case "datetime": {
                ...
                return Optional.of(datetimeColumnMapping(precision));
            }
        }
...
//        return delegate().getConnection(session, handle);
        ...
        try {
            connection.unwrap(SybConnection.class);
//                    .setUseBulkCopyForBatchInsert(isBulkCopyForWrite(session));
    ...
    private static Optional<DataCompression> getTableDataCompression(Handle handle, JdbcTableHandle table)
    {
        ...
        return handle.createQuery("" +
                        "SELECT 'NONE' as data_compression_desc ")
    ...
    public static <T> T retryOnDeadlock(CheckedSupplier<T> supplier, String attemptLogMessage)
    {
        ...
        RetryPolicy<T> retryPolicy = RetryPolicy.<T>builder()
                ...
                .handleIf(throwable ->
                {
                    ...
                    return rootCause instanceof SybSQLException &&
                            ((SybSQLException) (rootCause)).getErrorCode() == SQL_SERVER_DEADLOCK_ERROR_CODE;
                })
