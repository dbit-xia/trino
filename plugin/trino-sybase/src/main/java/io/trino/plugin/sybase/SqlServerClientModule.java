...
import static io.trino.plugin.sybase.SqlServerClient.SQL_SERVER_MAX_LIST_EXPRESSIONS;
        ...
        extends AbstractConfigurationAwareModule
{
    ...
    {
        return new SqlServerConnectionFactory(new DriverConnectionFactory(new SybDriver(), config, credentialProvider), sqlServerConfig.isSnapshotIsolationDisabled());
    }
}
